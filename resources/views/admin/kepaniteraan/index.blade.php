...
<div class="card shadow mb-4" >
    <div class="card-header py-3" style="background-color: #{{$sector->base_color}}">
      <h6 class="m-0 font-weight-bold " style="color: {{getContrastColor('#'.$sector->base_color)}}">Filter Data</h6>
    </div>
    <div class="card-body" >
        ...
        <tbody>
          ...
          <tr>
            ...
            <td>
              ...
              @if($edit == 1)
              <a href="{{url(session('role').'/pengawas-bidang/'.strtolower($sector->category).'/'.$sub_menu).'/'.$row->id.'/edit'}}" class="btn btn-primary btn-flat btn-sm"><i class="fa fa-pencil-square-o" aria-hidden="true"></i> uraian</a>
              @endif
